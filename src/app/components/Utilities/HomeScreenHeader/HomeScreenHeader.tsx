...
export default function HomeScreenHeader(
  ...
  setOpenFilter: any,
  setPersonalisation: any = null,
  personalisationAvailaible: boolean = false
) {
  ...
  return (
    <div className={`${styles.homescreen__header}`}>
      ...
      {isHomescreen ? (
        ...
        <div
          style={{
            opacity: personalisationAvailaible?1:0.3
          }}
          onClick={() => {
            setPersonalisation(1);
            setAnimationLottie(Resources.personalized);
            setTimeout(() => {
                window.location.assign(window.location.href+'&personalisation=1');
            }, 1000);
          }}
        >
          <Lottie
            ...
            height={30}
            width={30}
            isPaused={!personalisationAvailaible}
          ></Lottie>
        </div>
      )}
      {!isGuest ? (
